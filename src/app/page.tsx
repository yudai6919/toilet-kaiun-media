      ...
      <section id="about" className="py-28 md:py-36 px-6 bg-[#F7F3EC]">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div variants={fade} initial="hidden" whileInView="visible" custom={0} viewport={{ once: true }}>
            <p className="text-[#C8A96B] text-[10px] tracking-[0.5em] uppercase mb-8 font-light">
              About
            </p>
            ...
            {[
              {
                num: "01",
                title: "空間が整う",
                desc: "毎日使う場所を整えることで、暮らし全体の空気が少しずつ変わり始めます。",
              },
              {
                num: "02",
                title: "心が整う",
                desc: "目の前を無心で磨く時間が、散らかった思考を静かに整理してくれます。",
              },
              {
                num: "03",
                title: "行動が整う",
                desc: "小さな習慣が次の行動を連れてきます。整える力は、人生を動かす力です。",
              },
            ].map((item, i) => (
              <motion.div
                key={item.num}
              ...
              >
                ...
                <h3 className="text-lg font-bold text-[#2C2C2C] mb-3 tracking-wide">
                  {item.title}
                </h3>
                <p className="text-sm text-[#2C2C2C]/45 leading-[2] tracking-wide">
                  {item.desc}
                </p>
              </motion.div>
            ))}
            ...
            {[
              {
                ...
                tag: "30代・会社員",
                quote: "朝の空気が変わった気がした。毎朝トイレを磨くようになって、不思議と部屋全体を整えたくなった。",
                days: "継続 42日目",
              },
              {
                slug: "messy-room-messy-mind",
                tag: "40代・主婦",
                quote: "散らかった部屋を見て「心も散らかってたんだ」と気づいた。まずトイレから始めたら、少しずつ楽になれた。",
                days: "継続 28日目",
              },
              {
                slug: "wanted-to-feel-lighter",
                tag: "20代・フリーランス",
                quote: "人生を変えたかったわけじゃない。ただ楽になりたかった。トイレ掃除は、そのための小さな入口だった。",
                days: "継続 67日目",
              },
            ].map((voice, i) => (
              <motion.div
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-[10px] text-[#2C2C2C]/25 tracking-wide">
                      {voice.days}
                    </span>
                  </div>
          ...
          <div className="space-y-0">
            {[
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-bold text-[#2C2C2C] mb-2 tracking-wide">
                    {step.title}
                  </h3>
                  <p className="text-sm text-[#2C2C2C]/45 leading-[2] tracking-wide">
                    {step.desc}
