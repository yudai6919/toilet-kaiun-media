    ...
    <section className="pt-32 md:pt-40 pb-24 md:pb-32 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-[#2B2118]/70 text-sm leading-[2]">
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">1. 個人情報の収集について</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">2. 個人情報の利用目的</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">3. アクセス解析ツールについて</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">4. 個人情報の第三者提供</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">5. Cookieの使用について</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-[#2B2118] mb-3">6. プライバシーポリシーの変更</h2>
            <p>
