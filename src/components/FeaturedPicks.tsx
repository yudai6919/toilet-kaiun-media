...
export default function FeaturedPicks() {
  return (
    <section className="py-20 md:py-28 bg-cream-alt" aria-label="おすすめ記事">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {articles.map((article, i) => (
            ...
            >
              ...
              >
                <article className="rounded-2xl bg-white border border-cream-alt/50 p-6 md:p-7 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 hover:border-gold/25 h-full flex flex-col">
                  {/* Category */}
                  ...
                  {/* Title */}
                  <h3 className="font-[var(--font-zen-old-mincho)] text-[15px] md:text-base font-bold leading-[1.7] tracking-[0.02em] text-charcoal mb-3 group-hover:text-gold transition-colors duration-300 flex-1">
                    {article.title}
                  </h3>

                  {/* Description */}
                  <p className="text-[12px] text-charcoal/35 leading-[1.8] tracking-wide line-clamp-2 mb-4">
                    {article.description}
                  </p>

                  {/* Read link */}
                  <span className="text-[12px] font-semibold text-gold/50 group-hover:text-gold transition-colors duration-300">
                    読む &rarr;
                  </span>
                </article>
              </Link>
