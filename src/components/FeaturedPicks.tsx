...
export default function FeaturedPicks() {
  return (
    <section className="py-20 md:py-28 bg-[#F8F4EE]" aria-label="おすすめ記事">
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="font-[var(--font-zen-old-mincho)] text-2xl md:text-3xl font-bold leading-[1.5] tracking-[0.04em] text-[#2B2118] mb-4">
            まず読んでほしい、
            <br />
            整えの5記事
          </h2>
          <div className="w-10 h-px bg-[#B68A3D]/30 mx-auto mb-6" />
          <p className="text-sm text-[#2B2118]/40 leading-[2] tracking-wide">
            人生を整えたい日に読んでほしい、
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {articles.map((article, i) => (
            ...
            >
              ...
              >
                <article className="rounded-2xl bg-white border border-[#E8DDC8]/50 p-6 md:p-7 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 hover:border-[#B68A3D]/25 h-full flex flex-col">
                  {/* Category */}
                  ...
                  {/* Title */}
                  <h3 className="font-[var(--font-zen-old-mincho)] text-[15px] md:text-base font-bold leading-[1.7] tracking-[0.02em] text-[#2B2118] mb-3 group-hover:text-[#B68A3D] transition-colors duration-300 flex-1">
                    {article.title}
                  </h3>

                  {/* Description */}
                  <p className="text-[12px] text-[#2B2118]/35 leading-[1.8] tracking-wide line-clamp-2 mb-4">
                    {article.description}
                  </p>
