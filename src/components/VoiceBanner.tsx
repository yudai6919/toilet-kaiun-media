  ...
  return (
    <section className={`py-16 md:py-20 px-6 ${bgClass}`}>
      <div className="max-w-3xl mx-auto">
        <div className="rounded-2xl bg-charcoal p-8 md:p-10 text-center">
          ...
          <Link
            href="/voice"
            className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-charcoal tracking-wide transition-all duration-300 hover:bg-gold hover:text-white hover:-translate-y-0.5"
          >
